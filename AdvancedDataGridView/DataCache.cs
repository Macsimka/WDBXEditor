...
namespace ADGV
{
    public partial class AdvancedDataGridView : DataGridView
    {
        ...
        public void Init(bool force = false)
        {
            ...
            var table = (DataTable)((BindingSource)DataSource).DataSource;
        ...
        public Point Search(string text, bool exact, StringComparison comparison = StringComparison.CurrentCultureIgnoreCase, bool includestart = false)
        {
            ...
            var startcell = CurrentCell; //Our original
            var startindex = startcell.RowIndex;
            var startcolumn = startcell.ColumnIndex;
            bool looped = false;
            var hidden = new HashSet<int>(Columns.Cast<DataGridViewColumn>().Where(x => !x.Visible).Select(x => x.Index));
